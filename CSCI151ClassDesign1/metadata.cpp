...
void printMetadata(const Metadata& md)
{
	...
	std::cout << "filename: " << md.getFilename() << "\n";
	std::cout << "image type: " << md.getImageType() << "\n";
	std::cout << "date created: " << date[0] << "-" << date[1] << "-" << date[2] << "\n";
	std::cout << "size: " << md.getSize() << "\n";
	std::cout << "author name: " << md.getAuthorName() << "\n";
	std::cout << "dimensions: " << dimensions[0] << "x" << dimensions[1] << "\n";
	std::cout << "aperture size: " << md.getApertureSize() << "\n";
	std::cout << "exposure time: " << md.getExposureTime() << "\n";
	std::cout << "ISO: " << md.getISO() << "\n";
	std::cout << "flash enabled: " << (md.getFlashEnabled() ? "yes\n" : "no\n");
}
